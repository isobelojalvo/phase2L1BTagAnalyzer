...
# Schedule definition
process.schedule = cms.Schedule(process.p_btag,process.EcalEBtp_step,process.L1TrackTrigger_step,process.L1simulation_step,process.analyzer,process.endjob_step) 
